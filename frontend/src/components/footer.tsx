...
import { canopyTypes, cities, phone } from "@/data/site";
  ...
  return (
    <footer className="bg-steel-900 pb-24 pt-12 text-white md:pb-10">
      <div className="container grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          <p className="text-2xl font-black">Стальной Контур</p>
          ...
          <a className="mt-5 inline-block text-xl font-black" href={`tel:${phone.replace(/\D/g, "")}`}>{phone}</a>
        </div>
        <div>
