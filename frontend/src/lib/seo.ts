...
export const pagesSeo: PageSeo[] = [
  ...
  {
    path: "/naves-dlya-avto-v-krymu",
    title: "Навес для авто в Крыму под ключ — Стальной Контур",
    description: "Производство и монтаж навесов для авто в Крыму под ключ: замер, расчет стоимости, материалы, кейсы, гарантия и монтаж в городах Крыма.",
